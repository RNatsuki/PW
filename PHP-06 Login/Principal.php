      ...
      <div class="collapse navbar-collapse" id="navcol-1" style="height: 50px;">
        ...
        <ul class="navbar-nav ms-auto main-nav" style="height: 28px;">
          ...
          <li class="nav-item" style="height: 28px;margin-top: 6px;"><a class="nav-link"
           href="functions/signOut.php" style="background: #ffffff;height: 28px;padding: 0px;margin-top: 6px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" style="font-size: 25px;background: #ffffff;margin-top: -25px;">
